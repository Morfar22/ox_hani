...
return {
	...
	Ammunation = {
		...
		blip = {
			...
			vec3(-660.9, -938.05, 21.83),
			vec3(814.94, -2153.55, 29.62),
			vec3(1695.28, 3757.52, 34.71),
			vec3(-328.42, 6081.07, 31.45),
			vec3(248.93, -50.23, 69.94),
			vec3(16.15, -1109.04, 29.8),
			vec3(2566.56, 297.64, 108.73),
			vec3(-1114.88, 2697.26, 18.55),
			vec3(842.9, -1030.42, 28.19)
		}, targets = {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'WEAPON_PUMPSHOTGUN', price = 0, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 3 },
			{ name = 'WEAPON_STUNGUN', price = 0, metadata = { registered = true, serial = 'POL'} }
		}, locations = {
			vec3(609.0, -14.56, 76.63)
		}, targets = {
